...
export class News extends Component {
    ...
    async updateNews() {
        const url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=2d30b72893e1485ea0f9d8e49a188986&page=${this.state.page}&pageSize=${this.props.pageSize}`;
